...
lau::Matrix4D lau::Matrix4D::operator*(const Matrix4D& mat){
  return Matrix4D(m_[0] * mat.m_[0] + m_[1] * mat.m_[4] + m_[2] * mat.m_[8] + m_[3] * mat.m_[12], 
                  m_[0] * mat.m_[1] + m_[1] * mat.m_[5] + m_[2] * mat.m_[9] + m_[3] * mat.m_[13], 
                  m_[0] * mat.m_[2] + m_[1] * mat.m_[6] + m_[2] * mat.m_[10] + m_[3] * mat.m_[14],
                  m_[0] * mat.m_[3] + m_[1] * mat.m_[7] + m_[2] * mat.m_[11] + m_[3] * mat.m_[15], 

                  m_[4] * mat.m_[0] + m_[5] * mat.m_[4] + m_[6] * mat.m_[8] + m_[7] * mat.m_[12], 
                  m_[4] * mat.m_[1] + m_[5] * mat.m_[5] + m_[6] * mat.m_[9] + m_[7] * mat.m_[13], 
                  m_[4] * mat.m_[2] + m_[5] * mat.m_[6] + m_[6] * mat.m_[10] + m_[7] * mat.m_[14],
                  m_[4] * mat.m_[3] + m_[5] * mat.m_[7] + m_[6] * mat.m_[11] + m_[7] * mat.m_[15], 

                  m_[8] * mat.m_[0] + m_[9] * mat.m_[4] + m_[10] * mat.m_[8] + m_[11] * mat.m_[12], 
                  m_[8] * mat.m_[1] + m_[9] * mat.m_[5] + m_[10] * mat.m_[9] + m_[11] * mat.m_[13], 
                  m_[8] * mat.m_[2] + m_[9] * mat.m_[6] + m_[10] * mat.m_[10] + m_[11] * mat.m_[14],
                  m_[8] * mat.m_[3] + m_[9] * mat.m_[7] + m_[10] * mat.m_[11] + m_[11] * mat.m_[15], 

                  m_[12] * mat.m_[0] + m_[13] * mat.m_[4] + m_[14] * mat.m_[8] + m_[15] * mat.m_[12], 
                  m_[12] * mat.m_[1] + m_[13] * mat.m_[5] + m_[14] * mat.m_[9] + m_[15] * mat.m_[13], 
                  m_[12] * mat.m_[2] + m_[13] * mat.m_[6] + m_[14] * mat.m_[10] + m_[15] * mat.m_[14],
                  m_[12] * mat.m_[3] + m_[13] * mat.m_[7] + m_[14] * mat.m_[11] + m_[15] * mat.m_[15]);
}


lau::Vector4D lau::Matrix4D::operator*(const Vector4D& v) {
  return Vector4D(m_[0] * v[0] + m_[1] * v[1] + m_[2] * v[2] + m_[3] * v[3],
